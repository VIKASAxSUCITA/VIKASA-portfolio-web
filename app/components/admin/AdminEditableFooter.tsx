...
type SocialKey = keyof FooterContent["social"];

type AdminEditableFooterProps = {
  content: FooterContent;
  update: (updater: (prev: FooterContent) => FooterContent) => void;
};

export default function AdminEditableFooter({
  content,
  update,
}: AdminEditableFooterProps) {
  ...
  return (
    <div className="admin-editable-footer">
      <footer>
        <div
              ...
              <div className="row footer-custom-row">
                <div className="col-12 col-md-6">
                  <div className="footer-widget footer-widget-brand">
                    ...
                    <ul className="social-icons list-unstyled admin-footer-social-icons">
                      {SOCIALS.map((social) => (
                        <li key={social.key}>
                          <button
                            type="button"
                            className={`social-link text admin-footer-social-btn${
                              active === social.key ? " is-active" : ""
                            }`}
                    ...
                    <div className="admin-footer-url-panel">
                      {SOCIALS.map((social) =>
                        active === social.key ? (
                          <div
                            key={social.key}
                            className="admin-footer-url-field"
                          >
                            <span className="text text-14 admin-footer-social-label">
                              {social.label} URL
                            </span>
                            <EditableText
                              autoFocus
                              value={content.social[social.key]}
                              onChange={(value) =>
                                update((prev) => ({
                                  ...prev,
                                  social: {
                      ...
                      {!active ? (
                        <p className="text text-14 admin-footer-url-hint">
                          Click a social icon above to change its link URL.
                        </p>
                      ) : null}
                    </div>
                  </div>
                ...
                <div className="col-12 col-md-6">
                  <div className="footer-widget footer-widget-menu">
                    ...
                    <ul className="footer-menu list-unstyled">
                      <li>
                        <span className="text text-16">Home</span>
                      </li>
                      <li>
                        <span className="text text-16">About Us</span>
                      </li>
                      <li>
                        <span className="text text-16">Services</span>
                      </li>
                      <li>
                ...
                <div className="col-12 col-md-6">
                  <div className="footer-widget footer-widget-menu">
                    ...
                    <ul className="footer-menu list-unstyled">
                      <li>
                        <span className="text text-16">Investment</span>
                      </li>
                      <li>
                        <span className="text text-16">Business Enhancement</span>
                      </li>
                      <li>
