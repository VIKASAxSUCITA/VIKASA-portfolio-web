      ...
      {/* Main */}
          <main>
              ...
              <div className="content-inner">
                <div className="content-lists running-animation">
                  <div className="content-item">
                    <a href="/about" className="content-link">
                      <img
                      ...
                      >
                        <div className="card-icon">
                          <svg
                            ...
                            fill="none"
                          >
                            <g clipPath="url(#clip0_9088_5407)">
                              <path
                      ...
                      >
                        <div className="card-icon">
                          <svg
                            ...
                            fill="none"
                          >
                            <g clipPath="url(#clip0_9088_5460)">
                              <path
                      ...
                      >
                        <div className="card-icon">
                          <svg
                            ...
                            fill="none"
                          >
                            <g clipPath="url(#clip0_9088_5440)">
                              <path
                      ...
                      >
                        <div className="card-icon">
                          <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                          >
                            <g clipPath="url(#clip0_9105_30181)">
                              <path
                      ...
                      >
                        <div className="card-icon">
                          <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                          >
                            <g clipPath="url(#clip0_9105_30187)">
                              <path
            ...
            <div className="text-image-sticky mt-100">
              <div className="container">
                <div
                  className="section-headings section-headings-horizontal align-items-start overflow-hidden"
                >
                        ...
                        <div className="content section-headings">
                          ...
                          <div className="buttons" data-aos="fade-up">
                            ...
                            >
                              ...
                              <span className="visually-hidden"
                                >To learn more about the service, click this
                                button.</span
                              >
                            </a>
                          </div>
