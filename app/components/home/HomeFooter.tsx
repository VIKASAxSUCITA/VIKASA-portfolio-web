...
const SOCIALS = [
  {
    ...
    label: "Facebook",
    href: (c: FooterContent) => c.social.facebook,
    icon: (
  ...
  },
  {
    ...
    label: "Linkedin",
    href: (c: FooterContent) => c.social.linkedin,
    icon: (
  ...
  },
  {
    ...
    label: "Twitter",
    href: (c: FooterContent) => c.social.twitter,
    icon: (
  ...
  },
  {
    ...
    label: "Instagram",
    href: (c: FooterContent) => c.social.instagram,
    icon: (
