...
import AdminEventModal from "@/app/components/admin/AdminEventModal";
              ...
              <div className="container">
                <div className="section-headings text-center">
                  ...
                  <p className="text text-14 admin-insights-preview-note">
                    Click a card to edit schedule and details, or use Add for a
                    new event/announcement. After editing or deleting, click
